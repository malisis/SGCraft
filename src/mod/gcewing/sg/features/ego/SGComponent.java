...
public class SGComponent {
    ...
    public static IGuiRenderer defaultBackground(UIComponent component) {
        return GuiShape.builder(component).color(0x000000).border(1, 0xFFFFFF).alpha(200).build();
    }
    ...
    public static IGuiRenderer titleBackground(UIComponent component, String title) {
        return new TitleBackground(component, title, 0x000000, 200, 0xFFFFFF, 1, 0xFFFFFF, 0x363636);
    }

    public static IGuiRenderer errorBackground(UIComponent component, String title) {
