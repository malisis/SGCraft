...
public class GateUtil
{
	public static SGBaseTE findGate(World world, EntityPlayer player, int radius)
	{
		...
		for (MutableBlockPos pos : BlockPos.getAllInBoxMutable(playerPos.add(-radius, -radius, -radius),
	...
	{
		for (final BlockPos.MutableBlockPos nearPos : BlockPos.getAllInBoxMutable(pos.add(-radius, -radius, -radius),
